# Usage:
# python 04_05_yolo.py --video=<path to video file>
# python 04_05_yolo.py --image=<path to image file>
...
def postprocess(frame, outp):
    ...
    for i in indices:
        ...
        width = box[2]
        height = box[3]
        draw_pred(classIds[i], confidences[i], left, top, left + width, top + height)
...
while cv2.waitKey(1) < 0:
    ...
    outp = net.forward(get_outputs_names(net))
